                ...
                <form class="form" action="generator.php" method="post">
                    ...
                    <div class="form__content from__right">
                        ...
                        <div class="inputs">
                            <div class="inputs__item">
                                ...
                                <select class="item__input division" id="permanent_division" name="permanent_division"
                                    required>
                            ...
                            <div class="inputs__item">
                                ...
                                <select class="item__input district" id="permanent_district" name="permanent_district"
                                    required>
                            ...
                            <div class="inputs__item">
                                ...
                                <select class="item__input upozila" id="permanent_upazila" name="permanent_upazila"
                                    required>
                    ...
                    <div class="form__content from__right">
                        ...
                        <div class="inputs">
                            <div class="inputs__item">
                                <label class="item__label" for="name">বিভাগ</label>
                                <select class="item__input division" id="present_division" name="present_division"
                                    required>
                                    <option value="">বিভাগ সিলেক্ট করুন</option>
                                </select>
                            </div>
                            <div class="inputs__item">
                                <label class="item__label" for="name">জেলা</label>
                                <select class="item__input district" id="present_district" name="present_district"
                                    required>
                                    <option value="">জেলা সিলেক্ট করুন</option>
                                </select>
                            </div>
                            ...
                            <div class="inputs__item">
                                <label class="item__label" for="name">উপজেলা</label>
                                <select class="item__input upozila" id="present_upazila" name="present_upazila"
                                    required>
                                    <option value="">উপজেলা সিলেক্ট করুন</option>
                                </select>
                            </div>
                    ...
                    <div class="form__content from__right">
                        ...
                        <div class="inputs">
                            <div class="inputs__item">
                                <label class="item__label" for="name">বিভাগ</label>
                                <select class="item__input division" id="previous_edu_division"
                                    name="previous_edu_division" required>
                                    <option value="">বিভাগ সিলেক্ট করুন</option>
                                </select>
                            </div>
                            <div class="inputs__item">
                                <label class="item__label" for="name">জেলা</label>
                                <select class="item__input district" id="previous_edu_district"
                                    name="previous_edu_district" required>
                                    <option value="">জেলা সিলেক্ট করুন</option>
                                </select>
                            </div>
                            <div class="inputs__item">
                                <label class="item__label" for="name">উপজেলা</label>
                                <select class="item__input upozila" id="previous_edu_upazila"
                                    name="previous_edu_upazila" required>
                                    <option value="">উপজেলা সিলেক্ট করুন</option>
                                </select>
                            </div>
                            <div class="inputs__item">
                    ...
                    <div class="form__content from__right">
                        ...
                        <div class="inputs">
                            <div class="inputs__item">
                                <label class="item__label" for="name">বিভাগ</label>
                                <select class="item__input division" id="present_edu_division"
                                    name="present_edu_division" required>
                                    <option value="">বিভাগ সিলেক্ট করুন</option>
                                </select>
                            </div>
                            <div class="inputs__item">
                                <label class="item__label" for="name">জেলা</label>
                                <select class="item__input district" id="present_edu_district"
                                    name="present_edu_district" required>
                                    <option value="">জেলা সিলেক্ট করুন</option>
                                </select>
                            </div>
                            ...
                            <div class="inputs__item">
                                <label class="item__label" for="name">উপজেলা</label>
                                <select class="item__input upozila" id="present_edu_upazila" name="present_edu_upazila"
                                    required>
                                    <option value="">উপজেলা সিলেক্ট করুন</option>
                                </select>
                            </div>
